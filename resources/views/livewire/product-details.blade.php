						...
						<div class="detail-info">
							<div class="product-rating">
								...
								@foreach ($product->orderItems->where('review_status', 1) as $orderItem)
									@php
										$totalReviewNumb = $product->orderItems->where('review_status', 1)->count();
										$avgRating = $avgRating + $orderItem->review->rating/$totalReviewNumb;
									@endphp
								@endforeach
								@for ($i = 1; $i <= 5; $i++)
									@if ($i<=$avgRating)
											...
											<ol class="commentlist">
												...
												@foreach ($product->orderItems->where('review_status', 1) as $orderItem)
													...
													<div id="comment-20" class="comment_container"> 
														<img alt="{{$product->slug}}" src="{{asset('storage/media/products/' .$product->image)}}" height="80" width="80">
														<div class="comment-text">
															<div class="star-rating">
																<span class="width-{{$orderItem->review->rating *20}}-percent">Rated <strong class="rating">
								...
								<li class="product-item">
									<div class="product product-widget-style">
										...
										<div class="product-info">
											<a href="{{route('product.details', $popular_product->slug)}}" class="product-name"
                                            >
